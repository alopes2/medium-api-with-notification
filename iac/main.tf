...
resource "aws_lambda_permission" "apigw_lambda" {
  ...
  source_arn    = "arn:aws:execute-api:eu-central-1:044256433832:${aws_api_gateway_rest_api.api.id}/*/${aws_api_gateway_method.movie_get_method.method.http_method}${aws_api_gateway_resource.resource.path}"
}
